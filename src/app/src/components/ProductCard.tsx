...
export const ProductCard = ({ product }: ProductCardProps) => {
  return (
    <Card className="group relative overflow-hidden bg-gradient-surface border-border hover:shadow-hover transition-all duration-200 hover:scale-[1.02] cursor-pointer">
